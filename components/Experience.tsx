...
export function Experience() {
  ...
  return (
    <div className="max-w-6xl mx-auto" style={{ paddingTop: '80px', paddingBottom: '80px' }} ref={ref}>
      <motion.div
        ...
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <motion.div
              ...
              className="glass rounded-2xl p-8 md:p-10 border-2 border-zinc-800/50 hover:border-purple-500/30 transition-all group shadow-xl"
            >
              {/* Header */}
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6 gap-3 pb-6 border-b border-zinc-800/30">
                <div>
                  <h3 className="text-2xl mb-2 group-hover:text-purple-400 transition-colors">
                    {exp.role}
                  </h3>
                  <div className="flex items-center gap-2 text-zinc-400 mb-2 flex-wrap">
